...
<head>
	...
	<link href="css/metricsView.css" rel="stylesheet">
...
<body>
	...
	<div class="container">
		...
		<div id="metricsContainer">	
				<div id="chart_div1" class="metricsGraphDiv leftAligned">	
				
				</div>
				<div id="chart_div2"  class="metricsGraphDiv rightAligned">	
				
				</div>
				<div id="chart_div3" class="metricsGraphDiv leftAligned">	
				
				</div>
				<div id="chart_div4"  class="metricsGraphDiv rightAligned">	
    ...
    <script type="text/javascript" src="js/model/metricsModel.js"></script>
    <script type="text/javascript" src="js/metricsMain.js"></script>
